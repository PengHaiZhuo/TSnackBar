...
public abstract class BaseTransientTopBar<B extends BaseTransientTopBar<B>> {
  ...
  /**
   * Animation modes that can be set on the {@link BaseTransientTopBar}.
   *
   * @hide
   */
  ...
  public abstract static class BaseCallback<B> {
    ...
    /**
     * Called when the given {@link BaseTransientTopBar} has been dismissed, either through a
   ...
   *
   * @deprecated Use {@link com.phz.topsnackbar.ContentViewCallback} instead.
   */
  @Deprecated
  public interface ContentViewCallback
      extends com.phz.topsnackbar.ContentViewCallback {}
  ...
  @NonNull
  private final com.phz.topsnackbar.ContentViewCallback contentViewCallback;
  ...
  protected BaseTransientTopBar(
      ...
      @NonNull com.phz.topsnackbar.ContentViewCallback contentViewCallback) {
    if (parent == null) {
  ...
  protected int getSnackbarBaseLayoutResId() {
    return hasSnackbarStyleAttr() ? R.layout.mtrl_layout_top_snackbar : R.layout.design_layout_top_snackbar;
  }
  ...
  /**
   * Returns the anchor view for this {@link BaseTransientTopBar}.
   *
  ...
  /** Sets the view the {@link BaseTransientTopBar} should be anchored above. */
  @NonNull
  ...
  /**
   * Sets the id of the view the {@link BaseTransientTopBar} should be anchored above.
   *
  ...
  /**
   * Returns whether this {@link BaseTransientTopBar} is currently being shown, or is queued to
   * be shown next.
   */
  ...
  /** Behavior for {@link BaseTransientTopBar}. */
  public static class Behavior extends SwipeDismissBehavior<View> {
    ...
    private void setBaseTransientBottomBar(
        @NonNull BaseTransientTopBar<?> baseTransientBottomBar) {
