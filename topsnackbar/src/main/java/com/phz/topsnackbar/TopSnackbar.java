 ...
 * via {@link BaseTransientTopBar#addCallback(BaseCallback)}.
 */
...
public class TopSnackbar extends BaseTransientTopBar<TopSnackbar> {
   ...
   * existence of the base {@link BaseTransientTopBar} class.
   *
  ...
  private TopSnackbar(
      ...
      @NonNull TopSnackbarContentLayout contentViewCallback) {
